function [t1, y1, y1_nom, y_ref_array, quadrotorinput]=self_solverdynamics(ode, tspan, y0, options, current_hdl, tajector_ref_hdl)
...
y_ref_array = zeros(n_time, n_state);
y_ref_array(1,:) = y0(1,:)';
