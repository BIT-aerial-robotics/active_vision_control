...
#include "quadrotor_load_dynamics_L_att.cpp"
#include <mex.h>
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    if (nrhs != 21){ 
      mexErrMsgTxt("This problem expects 21 right hand side argument(s) since you have defined 21 MexInput(s)");
    } 
    ...
    setc_is_1(24) = tau_y;
    setc_is_1(25) = tau_z;
    CFunction cLinkModel_1( 19, quadrotor_load_dynamics_L_att ); 
    ...
    ocp1.subjectTo(AT_START, const_L == mexinput20);
    ocp1.subjectTo(r0_33 >= 8.00000000000000044409e-01);
    ocp1.subjectTo(r0_33 <= 8.49999999999999977796e-01);
    ocp1.subjectTo((-8.00000000000000000000e+00+pow(tau_x,2.00000000000000000000e+00)+pow(tau_y,2.00000000000000000000e+00)+pow(tau_z,2.00000000000000000000e+00)) <= 0.00000000000000000000e+00);
