...
function active_mpc_quadrotor(T)
clc;
close all;
if nargin < 1
    T = 10; 
...
scale = scale+1;
if (scale == 50)  %tune the sampling time
    scale = 0;
end
end
...
dy_nom  =   [v_nom; u_nom];  %u_nom = F, psi_dot
