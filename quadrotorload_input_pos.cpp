...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-1.00000000000000000000e+01) <= f_z <= 1.00000000000000000000e+01);
    ocp1.subjectTo((-4.00000000000000000000e+02+pow(f_x,2.00000000000000000000e+00)+pow(f_y,2.00000000000000000000e+00)) <= 0.00000000000000000000e+00);
