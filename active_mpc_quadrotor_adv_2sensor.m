...
%     cosbeta = (p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z)/((p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z)^2 + (p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z)^2 + (p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z)^2)^(1/2);
  ...
  p_b_cx = 0; p_b_cy  = 0; p_b_cz  = 0;
 

%the configuration of body frame relative to lidar frame
  p_b_lx  = 0; p_b_ly  = 0; p_b_lz  = 0;
 

%the rotation matrix of body frame relative to lidar frame
  rbl_11 = 1; rbl_12  = 0; rbl_13   = 0; rbl_21  = 0; rbl_22   = 1; rbl_23  = 0; rbl_31  = 0; rbl_32  = 0; rbl_33  = 1; 

%the rotation matrix of body frame relative to camera frame
  rbc_11 = 1; rbc_12  = 0; rbc_13  = 0;  rbc_21   = 0;  rbc_22   = 1; rbc_23   = 0; rbc_31   = 0;  rbc_32   = 0;  rbc_33   = 1; 

   cosbeta_c = (p_b_cx + rbc_11*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbc_12*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbc_13*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))/((p_b_cx + rbc_11*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbc_12*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbc_13*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))^2 + (p_b_cy + rbc_21*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbc_22*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbc_23*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))^2 + (p_b_cz + rbc_31*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbc_32*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbc_33*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))^2)^(1/2);
   cosbeta_l = (p_b_lx + rbl_11*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbl_12*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbl_13*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))/((p_b_lx + rbl_11*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbl_12*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbl_13*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))^2 + (p_b_ly + rbl_21*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbl_22*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbl_23*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))^2 + (p_b_lz + rbl_31*(p_fx*r0_11 + p_fy*r0_21 + p_fz*r0_31 - r0_11*x0_x - r0_21*x0_y - r0_31*x0_z) + rbl_32*(p_fx*r0_12 + p_fy*r0_22 + p_fz*r0_32 - r0_12*x0_x - r0_22*x0_y - r0_32*x0_z) + rbl_33*(p_fx*r0_13 + p_fy*r0_23 + p_fz*r0_33 - r0_13*x0_x - r0_23*x0_y - r0_33*x0_z))^2)^(1/2);
 
%  disp(['cos beta previous ', num2str(cosbeta)]);
%   disp(['cos beta current ', num2str(cosbeta_c)]);
%   disp(['cos beta current lidar', num2str(cosbeta_l)]);
 
    out = quadrotorload_input_adv_2sensor_RUN(t, t+hori_T, ...  %start time and final time 
