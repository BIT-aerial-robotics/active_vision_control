...
BEGIN_ACADO;                                % Always start with "BEGIN_ACADO". 
    ...
    acadoSet('problemname', 'quadrotorload_input'); 
    
     %sometimes, the name of the variables induces errors, I don't know why. 
    DifferentialState x0_x  x0_y  x0_z    	v0_x  v0_y  v0_z   	r0_11  r0_12  r0_13  r0_21  r0_22  	r0_23  r0_31  r0_32  r0_33     	omega0_x  omega0_y  omega0_z  cosbeta rBC_11  rBC_12  rBC_13  rBC_21  rBC_22  rBC_23  rBC_31  rBC_32  rBC_33 const_L;
    Control f_x f_y f_z tau_x tau_y tau_z omegaBC_x  omegaBC_y  omegaBC_z; 
...
%     coe_cbfqp_b10 = acado.MexInput;  %coeffecients of the cbf constraints
    ...
    f.linkCFunction('quadrotor_load_dynamics_L.cpp', 'quadrotor_load_dynamics_L');
%     f.linkCFunction('dynamics_null.cpp', 'quadrotor_load_dynamics_L');
    ...
    ocp.subjectTo( 'AT_START', cosbeta == acado.MexInput);
    
    ocp.subjectTo( 'AT_START', rBC_11 ==   acado.MexInput  );
    ocp.subjectTo( 'AT_START', rBC_12 ==   acado.MexInput);
    ocp.subjectTo( 'AT_START', rBC_13  == acado.MexInput );
    ocp.subjectTo( 'AT_START', rBC_21  == acado.MexInput );
    ocp.subjectTo( 'AT_START', rBC_22  == acado.MexInput );
    ocp.subjectTo( 'AT_START', rBC_23  == acado.MexInput );    
    ocp.subjectTo( 'AT_START', rBC_31  == acado.MexInput );
    ocp.subjectTo( 'AT_START', rBC_32  == acado.MexInput );
    ocp.subjectTo( 'AT_START', rBC_33  == acado.MexInput );
...
% 
    ocp.subjectTo(  -90 <=  f_z <= -50);  %the input constraints should be set to appropriate range 
% 
    ocp.subjectTo(    ( f_x^2  +  f_y^2 +  f_z^2  )  -10000<= 0); 
    ocp.subjectTo(    ( tau_x^2  +  tau_y^2 +  tau_z^2  )  -10<= 0);
...
cosbeta = -(r0_11^2*rBC_13*xCB_x + r0_21^2*rBC_13*xCB_x + r0_12^2*rBC_23*xCB_y + r0_31^2*rBC_13*xCB_x + r0_22^2*rBC_23*xCB_y + r0_13^2*rBC_33*xCB_z + r0_32^2*rBC_23*xCB_y + r0_23^2*rBC_33*xCB_z + r0_33^2*rBC_33*xCB_z + r0_11*rBC_13*x0_x + r0_12*rBC_23*x0_x + r0_21*rBC_13*x0_y + r0_13*rBC_33*x0_x + r0_22*rBC_23*x0_y + r0_31*rBC_13*x0_z + r0_23*rBC_33*x0_y + r0_32*rBC_23*x0_z + r0_33*rBC_33*x0_z - r0_11*rBC_13*x_f - r0_12*rBC_23*x_f - r0_13*rBC_33*x_f - r0_21*rBC_13*y_f - r0_22*rBC_23*y_f - r0_23*rBC_33*y_f - r0_31*rBC_13*z_f - r0_32*rBC_23*z_f - r0_33*rBC_33*z_f + r0_11*r0_12*rBC_13*xCB_y + r0_11*r0_13*rBC_13*xCB_z + r0_11*r0_12*rBC_23*xCB_x + r0_12*r0_13*rBC_23*xCB_z + r0_11*r0_13*rBC_33*xCB_x + r0_21*r0_22*rBC_13*xCB_y + r0_12*r0_13*rBC_33*xCB_y + r0_21*r0_23*rBC_13*xCB_z + r0_21*r0_22*rBC_23*xCB_x + r0_22*r0_23*rBC_23*xCB_z + r0_21*r0_23*rBC_33*xCB_x + r0_31*r0_32*rBC_13*xCB_y + r0_22*r0_23*rBC_33*xCB_y + r0_31*r0_33*rBC_13*xCB_z + r0_31*r0_32*rBC_23*xCB_x + r0_32*r0_33*rBC_23*xCB_z + r0_31*r0_33*rBC_33*xCB_x + r0_32*r0_33*rBC_33*xCB_y)/((x_f*(r0_11*rBC_11 + r0_12*rBC_21 + r0_13*rBC_31) + y_f*(r0_21*rBC_11 + r0_22*rBC_21 + r0_23*rBC_31) + z_f*(r0_31*rBC_11 + r0_32*rBC_21 + r0_33*rBC_31) - (r0_11*rBC_11 + r0_12*rBC_21 + r0_13*rBC_31)*(x0_x + r0_11*xCB_x + r0_12*xCB_y + r0_13*xCB_z) - (r0_21*rBC_11 + r0_22*rBC_21 + r0_23*rBC_31)*(x0_y + r0_21*xCB_x + r0_22*xCB_y + r0_23*xCB_z) - (r0_31*rBC_11 + r0_32*rBC_21 + r0_33*rBC_31)*(x0_z + r0_31*xCB_x + r0_32*xCB_y + r0_33*xCB_z))^2 + (x_f*(r0_11*rBC_12 + r0_12*rBC_22 + r0_13*rBC_32) + y_f*(r0_21*rBC_12 + r0_22*rBC_22 + r0_23*rBC_32) + z_f*(r0_31*rBC_12 + r0_32*rBC_22 + r0_33*rBC_32) - (r0_11*rBC_12 + r0_12*rBC_22 + r0_13*rBC_32)*(x0_x + r0_11*xCB_x + r0_12*xCB_y + r0_13*xCB_z) - (r0_21*rBC_12 + r0_22*rBC_22 + r0_23*rBC_32)*(x0_y + r0_21*xCB_x + r0_22*xCB_y + r0_23*xCB_z) - (r0_31*rBC_12 + r0_32*rBC_22 + r0_33*rBC_32)*(x0_z + r0_31*xCB_x + r0_32*xCB_y + r0_33*xCB_z))^2 + (x_f*(r0_11*rBC_13 + r0_12*rBC_23 + r0_13*rBC_33) + y_f*(r0_21*rBC_13 + r0_22*rBC_23 + r0_23*rBC_33) + z_f*(r0_31*rBC_13 + r0_32*rBC_23 + r0_33*rBC_33) - (r0_11*rBC_13 + r0_12*rBC_23 + r0_13*rBC_33)*(x0_x + r0_11*xCB_x + r0_12*xCB_y + r0_13*xCB_z) - (r0_21*rBC_13 + r0_22*rBC_23 + r0_23*rBC_33)*(x0_y + r0_21*xCB_x + r0_22*xCB_y + r0_23*xCB_z) - (r0_31*rBC_13 + r0_32*rBC_23 + r0_33*rBC_33)*(x0_z + r0_31*xCB_x + r0_32*xCB_y + r0_33*xCB_z))^2)^(1/2); 

cosalpha = cos(pi/3);    
ocp.subjectTo( cosalpha <= cosbeta <=1);

 
 
%     ocp.subjectTo(  t1_z^2/  ( t1_x^2  +  t1_y^2 +  t1_z^2  )   == 1);
...
END_ACADO;           % Alw1ays end with "END_ACADO".
...
out = quadrotorload_input_RUN(0, 0.5, ...  %start time and final time 
    0, 0, 1,...
    0, 0, 0,... %feedback states of the linear velocity of the load
    1, 0, 0, 0, 1, 0, 0, 0, 1,... %feedback states of rotation matrix of the load 
    0, 0, 0, ... %feedback states of the angular velocity of the load
    1,...% cosX value of beta angle (view angle)
    1, 0, 0, 0, 1, 0, 0, 0, 1,...% rotatation matrix of (from body frame to cerama frame)
    0); % load
